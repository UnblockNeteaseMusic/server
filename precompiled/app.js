...
const ENABLE_LOCAL_VIP="true"===(process.env.ENABLE_LOCAL_VIP||"").toLowerCase(),BLOCK_ADS="true"===(process.env.BLOCK_ADS||"").toLowerCase(),DISABLE_UPGRADE_CHECK="true"===(process.env.DISABLE_UPGRADE_CHECK||"").toLowerCase(),hook={request:{before:()=>{},after:()=>{}},connect:{before:()=>{}},negotiate:{before:()=>{}},target:{host:new Set,path:new Set}}
hook.target.host=new Set(["music.163.com","interface.music.163.com","interface3.music.163.com","apm.music.163.com","apm3.music.163.com","musicupload.netease.com"]),hook.target.path=new Set(["/api/v3/playlist/detail","/api/v3/song/detail","/api/v6/playlist/detail","/api/album/play","/api/artist/privilege","/api/album/privilege","/api/v1/artist","/api/v1/artist/songs","/api/artist/top/song","/api/v1/album","/api/album/v3/detail","/api/playlist/privilege","/api/song/enhance/player/url","/api/song/enhance/player/url/v1","/api/song/enhance/download/url","/api/song/enhance/download/url/v1","/api/song/enhance/privilege","/api/ad","/batch","/api/batch","/api/listen/together/privilege/get","/api/v1/search/get","/api/v1/search/song/get","/api/search/complex/get","/api/search/complex/page","/api/search/song/page","/api/cloudsearch/pc","/api/v1/playlist/manipulate/tracks","/api/song/like","/api/v1/play/record","/api/playlist/v4/detail","/api/v1/radio/get","/api/v1/discovery/recommend/songs","/api/usertool/sound/mobile/promote","/api/usertool/sound/mobile/theme","/api/usertool/sound/mobile/animationList","/api/usertool/sound/mobile/all","/api/usertool/sound/mobile/detail"])
...
Object.defineProperty(exports,"__esModule",{value:!0}),__webpack_require__(6251),__webpack_require__(9476),__webpack_require__(2340),__webpack_require__(458),__webpack_require__(2348),__webpack_require__(2248),__webpack_require__(7878),__webpack_require__(7451),__webpack_require__(9209),__webpack_require__(1683),__webpack_require__(8249),__webpack_require__(8647),__webpack_require__(7653),__webpack_require__(8030),__webpack_require__(7030),__webpack_require__(5054),__webpack_require__(5051),__webpack_require__(1911),__webpack_require__(9571),__webpack_require__(9887),__webpack_require__(2378),__webpack_require__(9523),__webpack_require__(1326),__webpack_require__(1508)
...
song.br=bitrate&&!isNaN(bitrate)?1e3*bitrate:null}catch(e){logger.debug(e,"Failed to decode and extract the bitrate")}if(!song.br){if(isHost("qq.com")&&song.url.includes(".m4a")&&(song.br=96e3),isHost("bilivideo.com")&&song.url.includes(".m4a")){const result=song.url.match(/-(\d+)k\.m4a/)
let bitrate=parseInt(result)
isNaN(bitrate)||bitrate<96||bitrate>999?bitrate=192e3:bitrate*=1e3,song.br=bitrate}isHost("googlevideo.com")&&(song.br=128e3)}if(headers&&(isHost("126.net")&&(song.md5=song.url.split("/").slice(-1)[0].replace(/\..*/g,"")),isHost("kuwo.cn")&&song.br<=32e4&&(song.md5=headers.etag.replace(/"/g,"")),isHost("qq.com")&&(song.md5=headers["server-md5"]),song.size=parseInt((headers["content-range"]||"").split("/").pop()||headers["content-length"])||0,!isHost("yt-download.org")&&"8192"!==headers["content-length"]))return Promise.reject()
...
let audioData=null
if(process.env.SELECT_MAX_BR){let audioDataArr=await Promise.allSettled(candidate.map((async source=>getAudioFromSource(source,audioInfo).catch((e=>{throw e&&(e instanceof RequestCancelled?logger.debug(e):logger.error(e)),e})))))
if(audioDataArr=audioDataArr.filter((result=>"fulfilled"===result.status)),0===audioDataArr.length)throw new SongNotAvailable("any source")
audioDataArr=audioDataArr.map((result=>result.value)),audioData=audioDataArr.reduce(((a,b)=>a.br>=b.br?a:b))}else if(process.env.FOLLOW_SOURCE_ORDER){for(let i=0;i<candidate.length;i++){const source=candidate[i]
...
exportGlobalErrorCauseWrapper("Error",(function(init){return function(message){return apply(init,this,arguments)}})),exportGlobalErrorCauseWrapper("EvalError",(function(init){return function(message){return apply(init,this,arguments)}})),exportGlobalErrorCauseWrapper("RangeError",(function(init){return function(message){return apply(init,this,arguments)}})),exportGlobalErrorCauseWrapper("ReferenceError",(function(init){return function(message){return apply(init,this,arguments)}})),exportGlobalErrorCauseWrapper("SyntaxError",(function(init){return function(message){return apply(init,this,arguments)}})),exportGlobalErrorCauseWrapper("TypeError",(function(init){return function(message){return apply(init,this,arguments)}})),exportGlobalErrorCauseWrapper("URIError",(function(init){return function(message){return apply(init,this,arguments)}})),exportWebAssemblyErrorCauseWrapper("CompileError",(function(init){return function(message){return apply(init,this,arguments)}})),exportWebAssemblyErrorCauseWrapper("LinkError",(function(init){return function(message){return apply(init,this,arguments)}})),exportWebAssemblyErrorCauseWrapper("RuntimeError",(function(init){return function(message){return apply(init,this,arguments)}}))},1911:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
var $=__webpack_require__(4006),call=__webpack_require__(4842),aCallable=__webpack_require__(3283),newPromiseCapabilityModule=__webpack_require__(5232),perform=__webpack_require__(6364),iterate=__webpack_require__(8173)
$({target:"Promise",stat:!0,forced:__webpack_require__(2976)},{allSettled:function(iterable){var C=this,capability=newPromiseCapabilityModule.f(C),resolve=capability.resolve,reject=capability.reject,result=perform((function(){var promiseResolve=aCallable(C.resolve),values=[],counter=0,remaining=1
iterate(iterable,(function(promise){var index=counter++,alreadyCalled=!1
remaining++,call(promiseResolve,C,promise).then((function(value){alreadyCalled||(alreadyCalled=!0,values[index]={status:"fulfilled",value},--remaining||resolve(values))}),(function(error){alreadyCalled||(alreadyCalled=!0,values[index]={status:"rejected",reason:error},--remaining||resolve(values))}))})),--remaining||resolve(values)}))
return result.error&&reject(result.value),capability.promise}})},2378:(__unused_webpack_module,__unused_webpack_exports,__webpack_require__)=>{"use strict"
