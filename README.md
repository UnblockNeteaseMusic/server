...
| QQ_COOKIE   | str  | QQ 音源的 uin & qm_keyst cookie        | `uin=<your_uin>; qm_keyst=<your_qm_keyst>`          |
| JOOX_COOKIE | str  | JOOX 音源的 wmid 和 session_key cookie | `wmid=<your_wmid>; session_key=<your_session_key>;` |
